...
<q-card class="q-pa-xl" style="width: 700px; max-width: 80vw;">
    ...
    <div style="text-align:center; padding-top:10px" >
        ...
        <q-btn class="button" color="accent"  no-caps rounded text-color="white" :label="$t('button.change_pass')" @click="editPass()" />
      </div>
</q-card>
    </q-dialog>
  </div>
...
export default {
  ...
  components:{
    ...
    storeMappingMixin({
      getters: {
        user: 'user/csoUserProfile',
        token: 'auth/token'
      }, actions: {
        fetchSpecificUser: 'user/fetchCSOUserProfile',
